...
> **สัญชาตญาณของ GELU:** ReLU ตัดสินแบบแข็ง — "ถ้า $z\lt{}0$ ทิ้ง" ส่วน GELU ตัดสินแบบนุ่ม — "เก็บ $z$ ไว้ตามความน่าจะเป็นที่ $z$ จะมากกว่า noise มาตรฐาน" ผลคือกราฟเรียบ ไม่มีจุดหักที่ทำให้ gradient กระโดด
>
...
= I + \sum_l J_l + \sum_{l\lt{}l'} J_{l'}J_l + \cdots
$$
...
> **จุดสำคัญ:** หน่วยที่ถูกตัดจะไม่มี gradient ไหลย้อนผ่านมันเลย ($\text{ReLU}'(z) = 0$ เมื่อ $z\lt{}0$) ถ้าหน่วยไหนติดลบ *ทุก input* ตลอดกาล จะกลายเป็น **dead unit** ที่ไม่มีวันฟื้น — นี่คือแรงจูงใจข้อหนึ่งของ GELU
...
4. **SwiGLU สลับเครื่องหมายได้** — หน่วยที่ 2 มี $h\lt{}0$ และ $g\lt{}0$ ผลคูณกลับเป็น **บวก** 0.1749 และหน่วยที่ 5 มี $h\gt{}0$ แต่ $g\lt{}0$ ผลกลับเป็น **ลบ** −0.1395 → gate ให้อิสระที่ ReLU/GELU ไม่มีเลย
